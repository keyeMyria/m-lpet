...
import CardItem from './card/onceCardItem'

class OnceCardManage extends React.Component {
...

                {
                    cardList.length == 0 ? <div className="kong-content">
                        <div className="kong">
                            ...
                            <p>您未添加任何次卡类型</p>
                            <a className="addBtn" onClick={this.addVipCard}>添加次卡</a>
                        </div>
                    </div>
                        :
